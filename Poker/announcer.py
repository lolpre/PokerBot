...
class Announcer:
    ...
    async def ask_balance(self, ctx):
        """
        This method ask_balance outputs the announcing message that asks participant for the starting balance 
        for the game.
        input: ctx -> part of Discord API, the context of the message
        """
    ...
    async def join_timer(self, ctx):
        """
        This method join_timer limits the time given for someone to join the game. the timer is 
        30 seconds long.
        input: ctx -> part of Discord API, the context of the message
        """
        time = 30
    ...
    async def join_queue(self, ctx):
        """
        This method join_queue outputs the announcing message that opens the game for people to join. 
        input: ctx -> a class object. part of Discord API, the context of the message
        """
    ...
    async def show_cards(self, ctx, hand):
        """
        This method show_cards reveals all the cards in a hand. outputs the message into the game channel.
        input: ctx -> a class object. part of Discord API, the context of the message
    ...
    async def show_comm_cards(self, ctx, comm_deck):
        """
        This method show_comm_cards reveals the community deck. outputs the mesasge into the game channel.
        input: ctx -> a class object. part of Discord API, the context of the message
    ...
    async def report_raise(self, ctx, name, amount):
        """
        This method report_raise outputs the announcing message that someone has raised the bet amount. 
        input: ctx -> a class object. part of Discord API, the context of the message
    ...
    async def report_call(self, ctx, name):
        """
        This method report_call outputs the announcing message that someone has called.
        input: ctx -> a class object. part of Discord API, the context of the message
